...
namespace StateAction
{
    public class AnimatorController : MonoBehaviour
    {
        ...
        public void LoadWeapon (Weapon weapon)
        {
            ...
            rightHandTarget.localEulerAngles = weapon.properties.modelInstance.transform.localEulerAngles;
            leftHandTarget = weapon.properties.weaponController.leftHandIkPosition;
